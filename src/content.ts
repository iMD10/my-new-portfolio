...
{ label: 'Details', href: '#' },
    ...
    about: {
      heading: 'عني',
      text: 'أنا مهند الفوزان، خريج علوم حاسب من جامعة القصيم بمعدل 4.96 من 5، والأول على دفعتي. أحب بناء منتجات رقمية مفيدة، خصوصاً اللي تجمع بين البرمجيات والذكاء الاصطناعي والبيانات وتجربة المستخدم.',
    },
    contact: {
